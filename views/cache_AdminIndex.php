        ...
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              <button class="btn btn-success d-flex justify-content-center align-content-between mr-1" onclick="get('/admin/edit_user_groups/<?php echo(htmlspecialchars($user -> id)); ?>')"><span class="material-icons">group</span></button>
              <button class="btn btn-primary d-flex justify-content-center align-content-between mr-1" onclick="get('/admin/edit_user/<?php echo(htmlspecialchars($user -> id)); ?>')"><span class="material-icons">create</span></button>
              <button class="btn btn-danger d-flex justify-content-center align-content-between" onclick="post('/admin/delete_user/<?php echo(htmlspecialchars($user -> id)); ?>')"><span class="material-icons">delete</span></button>
            </div>
          </td>
        </tr>
<?php  endforeach; ?>
...
<?php  foreach ($groups as $group) : ?>
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              <button class="btn btn-success d-flex justify-content-center align-content-between mr-1" onclick="get('/admin/edit_group_members/<?php echo(htmlspecialchars($group -> id)); ?>')"><span class="material-icons">group</span></button>
              <button class="btn btn-primary d-flex justify-content-center align-content-between mr-1" onclick="get('/admin/edit_group/<?php echo(htmlspecialchars($group -> id)); ?>')"><span class="material-icons">create</span></button>
              <button class="btn btn-danger d-flex justify-content-center align-content-between" onclick="post('/admin/delete_group/<?php echo(htmlspecialchars($group -> id)); ?>')"><span class="material-icons">delete</span></button>
            </div>
          </td>
        </tr>
<?php  endforeach; ?>
