...
[[ foreach ($groups as $group) : ]]
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              <button class="btn btn-success d-flex justify-content-center align-content-between mr-1" onclick="get('@@admin/edit_members/{{$group -> id}}@@')"><span class="material-icons">group</span></button>
