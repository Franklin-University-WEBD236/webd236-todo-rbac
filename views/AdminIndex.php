        ...
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              <button class="btn btn-success d-flex justify-content-center align-content-between mr-1" onclick="get('@@admin/user_groups/{{$user -> id}}@@')"><span class="material-icons">done</span></button>
