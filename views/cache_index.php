...
<?php  foreach ($dones as $todo) : ?>
        <tr>
          ...
          <td>
            <div class="btn-toolbar align-middle float-right">
              <button class="btn btn-success d-flex justify-content-center align-content-between mr-1" onclick="post('/todo/done/<?php echo(htmlspecialchars($todo['id'])); ?>')"><span class="material-icons">block</span></button>
              <button class="btn btn-primary d-flex justify-content-center align-content-between mr-1" onclick="get('/todo/edit/<?php echo(htmlspecialchars($todo['id'])); ?>')"><span class="material-icons">mode_edit</span></button>
              <button class="btn btn-danger d-flex justify-content-center align-content-between" onclick="post('/todo/delete/<?php echo(htmlspecialchars($todo['id'])); ?>')"><span class="material-icons">delete</span></button>
            </div>
          </td>
        </tr>
