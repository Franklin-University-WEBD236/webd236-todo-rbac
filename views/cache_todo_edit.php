...
<div class="row">
  <div class="col-lg-12">
    ...
    <form action="/todo/edit/<?php echo(htmlspecialchars($todo['id'])); ?>" method="post">
      <div class="form-group">
        <label for="description">Make your changes below</label>
        <input type="text" min="1" id="description" name="form[description]" class="form-control" placeholder="Enter description" value="<?php echo(htmlspecialchars($todo['description'])); ?>" />
        <input type="hidden" id="done" name="form[done]" value="<?php echo(htmlspecialchars($todo['done'])); ?>" />
      </div>
      <div class="form-group">
